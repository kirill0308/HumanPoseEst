...
class Plotter3d:
    # Re Ordered the position for Unity3D
    SKELETON_EDGES_FOR_UNITY = np.array([[6, 12],               # Hips
                               [6, 6], [7, 7], [8, 8],          # RightUpperLeg, RightLowerLeg, RightFoot
                               [12, 12], [13, 13], [14, 14],    # LeftUpperLeg, LeftLowerLeg, LeftFoot
                               [0, 0],                          # Spine - recalculated in main.py
                               [0, 0],                          # Chest  8
                               [1, 1],                        # Neck  9
                               [15, 17],                        # Head  10 - recalculated in main.py  - need to check not sure yet
                               [9, 9], [10, 10], [11, 11],       # RightUpperArm, RightLowerArm, RightHand
                               [3, 3], [4, 4], [5, 5]          # LeftUpperArm, LeftLowerArm, LeftHand
                               ])
    # SKELETON_EDGES_FOR_UNITY = np.array([[6, 12],               # Hips
    #                            [6, 6], [7, 7], [8, 8],          # RightUpperLeg, RightLowerLeg, RightFoot
    #                            [12, 12], [13, 13], [14, 14],    # LeftUpperLeg, LeftLowerLeg, LeftFoot
    ...
    #                            [0, 0],                          # Neck  8
    #                            [15, 17],                          # Undefined  9
    #                            [15, 17],                        # Head  10 - recalculated in main.py
    #                            [3, 3], [4, 4], [5, 5],          # LeftUpperArm, LeftLowerArm, LeftHand
    #                            [9, 9], [10, 10], [11, 11]       # RightUpperArm, RightLowerArm, RightHand
    #                            ])
    # Original
    SKELETON_EDGES = np.array([[11, 10],[10, 9],[9, 0],     # RightLowerArm, RightUpperArm, RightShoulder
                               [0, 3], [3, 4],[4, 5],       # LeftShoulder, LeftUpperArm, LeftLowerArm
                               [0, 6], [6, 7], [7, 8],      # LeftUpperLeg, LeftLowerLeg, LeftFoot
                               [0, 12],[12, 13],[13, 14],   # RightUpperLeg, RightLowerLeg, RightFoot
                               [0, 1],                      # Neck
                               [1, 15], [15, 16],           # Left Eye, Left Ear
                               [1, 17], [17, 18]])          # Right Eye, Right Ear
...
# # Re Ordered the position for Unity3D
# SKELETON_EDGES = np.array([[0, 1],  # Hips
#                            [0, 12], [12, 13], [13, 14],  # RUL, RLL, RF
#                            [0, 6], [6, 7], [7, 8],  # LUL, LLL, LF
#                            [0, 1],  # Spine
#                            [0, 1],  # Neck
#                            [0, 1],  # Undefined
#                            [0, 1],  # Head
#                            [0, 3], [3, 4], [4, 5],  # LUA, LLA, LH
#                            [0, 9], [9, 10], [10, 11]  # RUA, RLA, RH
#                            ])
